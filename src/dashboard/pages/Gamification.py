"""
Gamification Page - EyeD AI Attendance System
Page 7: Badges, achievements, leaderboards, and user engagement
"""
...
show_page_header(
    ...
    description="Badges, Achievements, Leaderboards & User Engagement",
    icon="🎮"
)

# Show the gamification component
show_gamification()

# Page footer
show_page_footer("Gamification System")
